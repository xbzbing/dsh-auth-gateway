 ...
 *
 * dsh's internal BrowserAuth requires a credential-backed cookie on forwarded
 * requests; the gateway mints it for the loopback hop.
 *
...
export function createForwarder({ upstreamHost, upstreamPort, upstreamSecretReader, onError }) {
   ...
   * does not know; the minted cookie is appended so other upstream cookies
   * remain available.
