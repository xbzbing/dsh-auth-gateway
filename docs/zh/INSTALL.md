...
- [NGINX-DEPLOYMENT.md](NGINX-DEPLOYMENT.md)（[English](../en/NGINX-DEPLOYMENT.md)）— 反向代理部署拓扑与 nginx 配置示例
- [DEPLOYMENT.md](DEPLOYMENT.md)（[English](../en/DEPLOYMENT.md)）— 端口与监听、LAN 部署、HTTPS 建议
- [SECURITY.md](SECURITY.md)（[English](../en/SECURITY.md)）— 威胁模型、OTP 密钥加密、恢复路径
