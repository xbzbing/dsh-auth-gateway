...
export class LoginGateway {
   ...
   */
  constructor({ listenHost, listenPort, upstreamHost, upstreamPort, basePath = '/', policy = {}, otp = {}, upstreamSecretReader, versionInfo, updateChecker, updateCheckAuto = false }) {
...
export function createGateway(config, { upstreamSecretReader, versionInfo, updateChecker, updateCheckAuto } = {}) {
  ...
  return new LoginGateway({ listenHost, listenPort, upstreamHost, upstreamPort, basePath, policy, otp, upstreamSecretReader, versionInfo, updateChecker, updateCheckAuto })
}
