...
export class LoginGateway {
   ...
   */
  constructor({ listenHost, listenPort, upstreamHost, upstreamPort, basePath = '/', policy = {}, otp = {}, upstreamSecretReader }) {
    ...
    this.otpRoutes = createOTPRoutes(this, {
      ...
      recordFailure: (address, now) => this.#recordFailure(address, now),
 ...
 */
export function createGateway(config, { upstreamSecretReader } = {}) {
  ...
  return new LoginGateway({ listenHost, listenPort, upstreamHost, upstreamPort, basePath, policy, otp, upstreamSecretReader })
}
