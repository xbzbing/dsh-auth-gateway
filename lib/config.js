...
const FIELDS = [
  ...
  // New-version notice in the settings panel. This is the ONLY outbound
  // request the plugin makes (a GET to the public npm registry's `latest`
  // tag; see lib/update-check.js), so an air-gapped or egress-restricted
  // deployment can set this false to keep the gateway fully offline. The
  // panel still shows the running version and the repository link.
  { key: 'updateCheck', def: true, kind: 'bool' },
]
