 ...
 */
export function createForwarder({ upstreamHost, upstreamPort, onError }) {
  const upstreamCookie = createUpstreamCookieMinter(`${upstreamHost}:${upstreamPort}`)
   ...
   */
  function forward(req, res, forwardPath) {
